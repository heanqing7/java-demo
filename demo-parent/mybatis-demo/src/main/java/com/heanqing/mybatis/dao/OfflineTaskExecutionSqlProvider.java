...
import com.horus.offline.domain.OfflineTaskExecution;
import com.horus.offline.domain.OfflineTaskExecutionExample;
import com.horus.offline.domain.OfflineTaskExecutionExample.Criteria;
import com.horus.offline.domain.OfflineTaskExecutionExample.Criterion;
...
public class OfflineTaskExecutionSqlProvider {
    public String countByExample(OfflineTaskExecutionExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("horus_v2_offline_task_execution");
    ...
    public String deleteByExample(OfflineTaskExecutionExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("horus_v2_offline_task_execution");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(OfflineTaskExecution record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("horus_v2_offline_task_execution");
    ...
    public String selectByExampleWithBLOBs(OfflineTaskExecutionExample example) {
        ...
        sql.SELECT("extra");
        sql.FROM("horus_v2_offline_task_execution");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        SQL sql = new SQL();
        sql.UPDATE("horus_v2_offline_task_execution");
